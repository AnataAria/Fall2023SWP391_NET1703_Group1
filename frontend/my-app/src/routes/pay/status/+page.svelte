<script lang="ts">
    ...
    if(status === 'success' && paymentID != null){
        formStatus.transactionID = paymentID;
        formStatus.status = "success";
        formStatus.title="Thank you for completing your secure online payment."
    }else{
        formStatus.transactionID = "";
        formStatus.status = "failed"
        formStatus.title = "Failed to complete your secure online payment"
    }
