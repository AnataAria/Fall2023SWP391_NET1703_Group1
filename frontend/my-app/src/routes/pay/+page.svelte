<script lang="ts">
    import { Button, Dropdown, DropdownItem, Toast } from "flowbite-svelte";
    import {
        CheckCircleSolid,
        ChevronDownSolid,
        CloseCircleSolid,
    ...
    let countries = [{ value: "USD", name: "USD" }];
    let paypal = true;
    let other = false;
    let rate: number = 0;
    interface IOrder {
    ...
    function CheckInput() {
        if (order.price <= 0) {
            showErrMessage("Total cannot be less than or equal to 0");
        }
        if (order.currency === ""){
...
<div
    class="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16 mt-20"
>
    <div
    ...
    >
        <div class="w-full pt-1 pb-5">
            <div
                class="bg-indigo-400 text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center"
            >
        ...
        {#if paypal}
            <div class="mb-3">
                <label for="total" class="font-bold text-sm mb-2 ml-1"
                    >Total</label
                >
                <div>
                    <input
            ...
            <div class="mb-3">
                <div>
                    <div>
                        <label
                            for="default-input"
                            class="font-bold text-sm mb-2 ml-1"
                            >Payment Method</label
                        >
                        <input
                            bind:value={order.method}
                            readonly
                            type="text"
                            id="default-input"
