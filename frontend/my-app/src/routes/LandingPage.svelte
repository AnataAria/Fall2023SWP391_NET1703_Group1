  ...
  function checkCookie() {
    ...
    for (let i = 0; i < cookie.length; i++) {
      ...
      if (c.startsWith("USER" + "=")) {
        status = "Logout";
        return decodeURIComponent(c.substring(5));
      }
    }
  }
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      <img
        src="http://webcoban.vn/image/flower.gif"
  ...
  <br />
  <!-- carousel-->
  <center style="background-size: cover;">
    <Carousel />
  </center>
          ...
          <div class="content col-xl-5 d-flex align-items-stretch">
            <div class="content">
              ...
              <a href="#" class="about-btn"
                ><span>About us</span> <i class="bx bx-chevron-right" /></a
              >
            </div>
          </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li>
                <i class="bx bx-chevron-right" /> <a href="#">About us</a>
              </li>
              <li>
                <i class="bx bx-chevron-right" /> <a href="#">Services</a>
              </li>
              <li>
              ...
              <li>
                <i class="bx bx-chevron-right" /> <a href="#">Privacy policy</a>
              </li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li>
                <i class="bx bx-chevron-right" /> <a href="#">Web Design</a>
              </li>
              <li>
                <i class="bx bx-chevron-right" />
              ...
              <li>
                <i class="bx bx-chevron-right" /> <a href="#">Marketing</a>
              </li>
              <li>
                <i class="bx bx-chevron-right" /> <a href="#">Graphic Design</a>
              </li>
            </ul>
          </div>
    ...
    <div class="container d-md-flex py-4">
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Presento</span></strong>. All Rights
          Reserved
        </div>
        <div class="credits">
