<script lang="ts">
  ...
  let spanClass = 'flex-1 ml-3 whitespace-nowrap';
	...
	{
		"id": 1,
		"title": "Before we started",
		"description": "Before start course",
		"videoLink": "https://www.youtube.com/embed/mcY3Kb2awIE" ,
		"createDate": "2023-10-17"
	},
	{
		"id": 2,
		"title": "Before we started again",
		"description": "Before start course",
		"videoLink": "https://www.youtube.com/embed/rKEXU77SpHQ" ,
		"createDate": "2023-10-17"
	},
	{
		"id": 3,
	...
	<div class="col-span-4">
		<div class="">
			...
			<!-- {#each posts as post }
				{#if post.id == id}
					<div>
						<iframe width="1220" height="686" src={post.videoLink} title="Chosen&#39;s Modded Adventure LIVE 15.5 - HÔM NAY LÀM GÌ ĐÂY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
					</div>
				{/if}
