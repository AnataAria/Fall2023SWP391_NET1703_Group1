      ...
      <TableBody  >
        {#if searchTerm !== ''}
          ...
          <TableBodyRow>
            ...
            <TableBodyCell tdClass="px-4 py-3"><Button color="red" pill>Disable</Button></TableBodyCell>
          {:else}
        ...
        {:else}
          {#each currentPageItems as item (item.id)}
            <TableBodyRow>
              ...
              {#if item['Account Status']==true}
              <TableBodyCell tdClass="px-4 py-3" class="text-lg">Enable</TableBodyCell>
              <TableBodyCell tdClass="px-4 py-3"><Button color="red" pill on:click>Disable</Button></TableBodyCell>
            {:else}
              <TableBodyCell tdClass="px-4 py-3" class="text-lg">Disable</TableBodyCell>
