<script lang="ts">
  ...
  import { apiBaseUrl } from "../../../../service";
    import type { EditCourse, EditCourseContent } from "$lib/types";
  ...
  <div class="p-4 col-span-3">
    <div class="w-full">
      <div class="bg-slate-600">
        <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4 w-full h-96">
          <!--Left-->
          ...
          {#if !editCourse}
            ...
            <div class="bg-white shadow rounded-lg p-6 h-full">
              <h1 class="text-2xl font-bold mb-4">Course Information <span><Button color="alternative" size="xs" on:click={ChangeMode}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <div>
                <div>Description</div>
                <textarea disabled bind:value={course.description} id="editinput" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
              </div>
              <div /> 
            </div>
          ...
          {#if editCourse}
            <div class="col-span-4 sm:col-span-9 h-full">
            <div class="bg-white shadow rounded-lg p-6 h-full">
              <h1 class="text-2xl font-bold mb-4">Course Information <span><Button color="alternative" size="xs" on:click={ChangeView}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
              </svg>
              </Button></span></h1> 
              <br />
              ...
              <div>
                <div>Description</div>
                <textarea bind:value={course.description} id="editinput" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
              </div>
              <Button pill color="red" on:submit={ChangeCourseInfo}>Save</Button>
              <div />
            </div>
            <!-- -->
          </div>
      ...
      <div class="h-screen w-full border-spacing-1 mt-10">
        ...
        <form class="w-full max-w-sm">
          ...
          <div class="flex items-center border-b border-teal-500 py-2">
            ...
            <button on:submit={ChangeSessionInfo} class="flex-shrink-0 border-transparent border-4 text-teal-500 hover:text-teal-800 text-sm py-1 px-2 rounded" type="reset">
              Cancel
            </button>
          </div>
        </form>
        ...
        <form>
          ...
          <div class="relative z-0 w-full mb-6 group">
            <div>
              <div>Description</div>
              <textarea bind:value={courseContent.description} id="editinput" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
            </div>
          </div>
          <div class="relative z-0 w-full mb-6 group">
            <input
